...
```bash
openclaw skills list | grep -E "kalshalyst|kalshi-command|polymarket-command|prediction-market-arbiter|xpulse|portfolio-drift|market-morning-brief|prediction-stack-setup"
```
...
**Full stack:** All 8 skills. Morning Brief pulls from every cache and auto_trader handles execution.
